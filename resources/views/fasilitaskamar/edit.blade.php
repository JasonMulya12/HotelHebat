...
<div class="row">
    ...
    <form action="{{ route('fasilitaskamar.update', $fasilitaskamar->id) }}" method="POST" enctype="multipart/form-data"> 
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="fasilitas_kamar" class="form-control" placeholder="Fasilitas Kamar" value="{{$fasilitaskamar->fasilitas_kamar}}">
                </div>
            </div>
